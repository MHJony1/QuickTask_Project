      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8">
                  ...
                  {!isPremium && (
                    <>
                      ...
                      <span className="text-amber-600 font-medium">
                        {totalTasks >= 3
                          ? 'Limit reached!'
                          : `${3 - totalTasks} of 3 tasks remaining`}
                      </span>
                    </>
                  )}
                </p>
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            {isPremium ? (
              <div className="flex items-center gap-2 bg-linear-to-r from-yellow-50 to-amber-50 px-4 py-2 rounded-xl border border-yellow-200/50 shadow-sm">
                <Crown size={18} className="text-yellow-500" />
                <span className="text-sm font-bold text-yellow-700">
                  Premium
                </span>
                <span className="text-xs text-yellow-600 bg-yellow-200/50 px-2 py-0.5 rounded-full">
                  Unlimited
                </span>
              </div>
            ) : (
          ...
          {[
            ...
            >
              <div className="relative flex items-center justify-between">
                ...
                <div
                  className={`w-10 h-10 bg-gradient-to-br ${stat.gradient} rounded-xl flex items-center justify-center shadow-md`}
                >
